...
public class TarefaController {
    ...
    public ResponseEntity<Tarefa> getById(@PathVariable Long id) {
        return tarefaRepository.findById(id).map(resposta -> ResponseEntity.ok(resposta))
    ...
    public ResponseEntity<List<Tarefa>> getByTitulo(@PathVariable String nome) {
    ...
    public ResponseEntity<?> deletePostagem(@PathVariable Long id) {
        ...
        return tarefaRepository.findById(id).map(resposta -> {
